...
CREATE TABLE Inventory (
    ...
    category_name VARCHAR(50) NOT NULL -- move to item
);
...
CREATE TABLE Items (
    ...
    item_stocks INT DEFAULT 0 CHECK (item_stocks >= 0), -- move to inventory
...
CREATE TABLE Sales ( -- change to report
...
CREATE TABLE Sales_Details ( -- change to sales
